...
// take contract off of computer and put them on the blockchain.
async function main() {
  // set up accounts.
  ...
  console.log(`Deploy Real Estate Contract at: ${realEstate.address}`)
  console.log(`Minting 3 properties...\n`)

  // mint 3 nfts.
  // iterate nftID by 1 (i + 1)
  for(let i = 0; i < 3; i++) {
